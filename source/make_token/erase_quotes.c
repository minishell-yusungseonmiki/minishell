...
/*   Updated: 2023/12/04 16:50:22 by yusung           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/minishell.h"

static char	*single_quote(char *elem, int *i)
{
	int		start;
	int		end;
	char	*tmp;
...
static char	*double_quote(char *elem, int *i, t_list *env)
{
	int		start;
	int		end;
	char	*tmp;
...
static char	*not_quote(char *elem, int *i, t_list *env)
{
	int		start;
	int		end;
	char	*tmp;
